...
from intent_analysis_gemini import IntentAnalysisModule
...
def main():
    output_path = os.path.join(os.path.dirname(__file__), "image_test_results_gemini_except_color_fabric.json")
